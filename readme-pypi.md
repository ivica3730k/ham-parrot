<!-- generated from README.md at tag v0.1.0 by scripts/build_pypi_readme.py; do not hand-edit -->
...
| `--mic-level 0-100` | Gain (percent, linear) applied to the mic passthrough. 100 = unity. |
| `--recorder-out-level 0-100` | Gain applied when playing `recording.wav`. 100 = unity (source WAV level). |
...
MIT. See [LICENSE](https://github.com/ivica3730k/ham-parrot/blob/v0.1.0/LICENSE).
